...
//        System.out.println("SELECT " + Config.getDBColumn() + " FROM " + Config.getDBTable() + " WHERE player='" + uuid.toString() + "';");
        return executeQuery("SELECT " + Config.getDBColumn() + " FROM " + Config.getDBTable() + " WHERE player='" + uuid.toString() + "';").length() != 0;
    }

    public static Long getPlaytime(UUID uuid) {
//        System.out.println("getPlaytime");
        String result = executeQuery("SELECT " + Config.getDBColumn() + " FROM " + Config.getDBTable() + " WHERE player='" + uuid.toString() + "';");
        if(getExists(uuid)) {
...
//        System.out.println("setPlaytime");
        if(getExists(uuid)) {
//            System.out.println("UPDATE " + Config.getDBTable() + " SET " + Config.getDBColumn() + "='" + playtime + "' WHERE player='" + uuid.toString() + "';");
            executeSQL("UPDATE " + Config.getDBTable() + " SET " + Config.getDBColumn() + "='" + playtime + "' WHERE player='" + uuid.toString() + "';");
        } else {
            executeSQL("INSERT INTO " + Config.getDBTable() + " (player, " + Config.getDBColumn() + ") VALUES ('" + uuid.toString() + "', '" + playtime + "');");
        }
    }
